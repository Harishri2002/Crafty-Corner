        ...
        <div class="container custom-container">
            ...
            <div class="row">
                <div class="col-lg-6 col-12 col-custom">
                        ...
                        <form action="controller/cartplaceorder.php" method="POST" novalidate>
                    ...
                    <div class="your-order">
                        ...
                        ?>
                            <table class="table">
                                ...
                                <tbody>
                                    <tr class="cart_item">
                                        <td class="cart-product-name"><?php echo $row['p_name'] ?> 
                               </td>
                                        <td class="cart-product-total text-center"><?php echo $row['cr_quantity']?></td>
                                    
                                    
                                        <!-- <td class="cart-product-name"> Service Charge :<?php echo $row2['s_charge']?><strong class="product-quantity"> -->
                                </strong></td>
                                        <td class="cart-product-total text-center"><span class="amount"><?php echo $total?></span></td>
                                    </tr>
                                </tbody>
                                <tfoot>
								<?php  } ?>
							...
							<h6>No Service Charge Applied for More Bulk Orders.</h6>
                        </div>
